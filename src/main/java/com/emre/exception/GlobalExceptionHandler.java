...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage > handlerJava7MonoException(CompanyException exception){
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage > handlerJava7MonoException(EmployeeException exception){
        return new ResponseEntity(createErrorMessage(exception.getErrorType(),exception),exception.getErrorType().getHttpStatus());
    }
